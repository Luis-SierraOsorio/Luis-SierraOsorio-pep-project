...
public class AccountDAO {
    ...
    public Account insertAccount(Account user) {
        ...
        try {
            ...
            // block gets newly generated key and returns new Account object with proper
            // fields
            if (results.next()) {
    ...
    public Account getAccountById(int account_id) {
        ...
        try {
            ...
            // iterating through results, creating accoutn object with fields and returing
            // Account object
            while (results.next()) {
                Account account = new Account(results.getInt("account_id"), results.getString("username"),
